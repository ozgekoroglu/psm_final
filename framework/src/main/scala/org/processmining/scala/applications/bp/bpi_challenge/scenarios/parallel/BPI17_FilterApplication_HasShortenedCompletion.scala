...
private object BPI17_FilterApplication_HasShortenedCompletion extends TemplateForBpi2017CaseStudyApplication {
...
//    println(s"Found ${logProjected.traces().size} traces with projection.")
    ...
    CsvWriter.logToCsvLocalFilesystem(
      logShortenedCompletion.filterByAttributeNames(ApplicationEvent.schema: _*),

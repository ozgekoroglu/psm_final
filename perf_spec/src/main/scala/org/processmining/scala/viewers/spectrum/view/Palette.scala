...
class DefaultPalette extends Palette {
  ...
  override def getClazzColor(clazz: Int, a: Int) =
    clazz match {
//      case 0 => new Color(151, 195, 10, a)
//      case 1 => new Color(255, 204, 0, a)
//      case 2 => new Color(255, 0, 0, a)
//      case 3 => new Color(0xfc, 0x8d, 0x59, a)
//      case 4 => new Color(204, 204, 204, a)
//      case 5 => new Color(0, 51, 102, a)
...
class BwQ4Palette extends Palette {
  ...
  override def getClazzColor(clazz: Int, a: Int) =
    clazz match {
      case -1 => new Color(0xff, 0xff, 0xff, a)
      case 0 => new Color(0x45, 0x75, 0xb4, a)
      case 1 => new Color(0x91, 0xbf, 0xdb, a)
      case 2 => new Color(0xf3, 0xe0, 0x90, a)
      case 3 => new Color(0xfc, 0x8d, 0x59, a)
      case 4 => new Color(0xff, 0x0, 0x0, a)
      case 5 => new Color(0xff, 0x0, 0xff, a)
      case _ => {
        val s = clazz - 3
        new Color(Math.min(255, s * 10), Math.min(255, s * 5), Math.max(0, 255 - s * 10), a)
      }
...
class OutliersPalette extends Palette {

  override def getDefaultGridColor() = Color.lightGray

  override def getClazzColor(clazz: Int, a: Int) =
    clazz match {
      case 1 => new Color(151, 195, 10, a)
      case 0 => new Color(255, 204, 0, a)
      case 2 => new Color(255, 0, 0, a)
      case 3 => new Color(204, 204, 204, a)
      case 4 => new Color(0, 51, 102, a)
      case _ => {
        val s = clazz - 4
        new Color(Math.min(255, s * 10), Math.min(255, s * 5), Math.max(0, 255 - s * 10), a)
      }
